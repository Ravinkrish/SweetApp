webapp.controller('reportDetailController', ['$scope', 'reportService','$stateParams','$state','orderService',
    function ($scope, reportService,$stateParams,$state,orderService) {
    ...
    $scope.gettingSingleOrder = function (orderId) {
                orderService.gettingSingleOrder(orderId).then(function (res) {
                    $scope.orderSettings = res.data;
                    console.log('asdasdsad', $scope.orderSettings);
                });
            };
